...
1.	**Launch** a browser and **Navigate** to [Azure Portal](https://portal.azure.com target="_blank"). **Login** with the Microsoft Azure credentials you received via email. 
