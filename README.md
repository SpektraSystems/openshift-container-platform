...
2. [Lab 1: Introduction to Azure Portal](/Lab%201:%20Introduction-to-Azure-Portal.md)	
   1. [Exercise 1: Log into your Azure Portal](/Lab%201:%20Introduction-to-Azure-Portal.md#exercise-1-log-into-your-azure-portal)
   2. [Exercise 2: Verify access to the Subscription](/Lab%201:%20Introduction-to-Azure-Portal.md#exercise-2-verify-access-to-the-subscription)	
3. [Lab 2: Deploying Open Shift cluster using ARM templates](/Lab%202:%20Deploying-OpenShift-cluster-using-ARM-templates.md)
   1. [Exercise 1: Create an Azure AD Application](/Lab%202:%20Deploying-OpenShift-cluster-using-ARM-templates.md#exercise-1-create-an-azure-ad-application)
